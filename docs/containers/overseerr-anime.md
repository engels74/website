...
<tr><td><div class="tag-decoration-latest">latest</div><div id="tag31775" onclick="CopyToClipboard('tag31775');return false;" class="tag-decoration">release</div><div id="tag3219" onclick="CopyToClipboard('tag3219');return false;" class="tag-decoration">release-8d00d71</div><div id="tag27866" onclick="CopyToClipboard('tag27866');return false;" class="tag-decoration">release-b8463f61b13060c65698bc26a410494c7ac3a27e</div></td><td>Releases</td><td><a href="https://github.com/engels74/overseerr-anime/commit/8d00d71eda06c266c3196dc37acae4e8a403a419" target="_blank">ci(docker): point anime image at gated warning source--Update the archived image metadata to build from the pushed source commit containing the modal-style warning and five-close snooze gate.--Constraint: Docker builds fetch source archives by remote commit SHA, so meta.json must follow the pushed source branch.--Rejected: Wait for scheduled update | this push should immediately make the release branch represent the intended image source.--Confidence: high--Scope-risk: narrow--Directive: Re-run update-versions.sh after any final source warning changes before archiving the image repo.--Tested: jq meta.json parse; Ruby YAML parse for workflows; bash -n scripts; metadata commands match current values; GitHub source archive HEAD resolves; git diff --check.--Not-tested: Full Docker image build and GHCR smoke test locally.</a></td><td><a href="https://github.com/engels74/overseerr-anime/actions/runs/26318023707" target="_blank">2026-05-23 00:12:25</a></td></tr>
</tbody>
  </table>
</div>
