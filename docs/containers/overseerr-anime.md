...
<tr><td><div class="tag-decoration-latest">latest</div><div id="tag24276" onclick="CopyToClipboard('tag24276');return false;" class="tag-decoration">release</div><div id="tag23674" onclick="CopyToClipboard('tag23674');return false;" class="tag-decoration">release-69d9d66</div><div id="tag1564" onclick="CopyToClipboard('tag1564');return false;" class="tag-decoration">release-8e09ac31f62103ebab4c77628720dde1c4751477</div></td><td>Releases</td><td><a href="https://github.com/engels74/overseerr-anime/commit/69d9d66cd63a67da5289742065537a3577e78daf" target="_blank">ci(docker): align anime image with current build workflows--Keep the soon-to-be-archived image buildable on the current shared base-image workflow stack and make the final image track the pushed warning source commit.--Constraint: The source warning commit had to be pushed first because the Docker workflow fetches public source archives by remote ref.--Rejected: Continue tagging source-only releases | the current sibling Docker repos use metadata commands to track moving upstream refs.--Confidence: high--Scope-risk: moderate--Directive: Before final archival, confirm the source branch SHA in meta.json is the intended final app source.--Tested: jq meta.json parse; Ruby YAML parse for workflows; bash -n scripts; meta commands match current values; GitHub source archive HEAD resolves; git diff --check.--Not-tested: Full Docker image build and GHCR smoke test locally.</a></td><td><a href="https://github.com/engels74/overseerr-anime/actions/runs/26317111224" target="_blank">2026-05-22 23:37:50</a></td></tr>
</tbody>
  </table>
</div>
